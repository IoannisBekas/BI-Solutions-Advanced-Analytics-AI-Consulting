...
const resources = {
    ...
    fr: {
        translation: {
            ...
            hero: { headline: 'Recherche Quantitative Institutionnelle', subheadline: 'Signaux IA sur le momentum, le risque, le sentiment et la stratégie.', placeholder: 'Ticker, entreprise, crypto, matière première...', popular: 'Populaire :', generateReport: 'Générer le rapport', viewReport: 'Voir le rapport', compare: 'Comparer deux actifs', liveActivity: 'En direct' },
            report: { generating: 'Analyse de {{ticker}}...', complete: 'Analyse terminée', signals: '{{count}} signaux traités', sharedReport: 'Rapport partagé', reportId: 'ID de rapport', generatedAt: 'Généré', researchers: 'chercheurs', viewFull: 'Voir le rapport complet', subscribe: "S'abonner à {{ticker}}", nextRefresh: 'Prochaine actualisation : {{hours}}h' },
    ...
    de: {
        translation: {
            ...
            hero: { headline: 'Institutionelle Quantitative Forschung', subheadline: 'KI-gestützte Signale für Momentum, Risiko, Sentiment und Strategie.', placeholder: 'Ticker, Unternehmen, Krypto, Rohstoff...', popular: 'Beliebt:', generateReport: 'Bericht erstellen', viewReport: 'Aktuellen Bericht ansehen', compare: 'Zwei Assets vergleichen', liveActivity: 'Live' },
    ...
    pt: {
        translation: {
            ...
            hero: { headline: 'Pesquisa Quantitativa Institucional', subheadline: 'Sinais de IA para momentum, risco, sentimento e estratégia.', placeholder: 'Ticker, empresa, cripto, commodities...', popular: 'Popular:', generateReport: 'Gerar relatório', viewReport: 'Ver relatório atual', compare: 'Comparar dois ativos', liveActivity: 'Ao vivo' },
    ...
    ja: {
        translation: {
            nav: { home: 'ホーム', watchlist: 'ウォッチリスト', archive: 'アーカイブ', screener: 'スクリーナー', methodology: 'メソドロジー', settings: '設定', signIn: 'ログイン', signUp: '登録', signOut: 'ログアウト' },
            hero: { headline: '機関投資家向け定量リサーチ', subheadline: 'モメンタム、リスク、センチメント、戦略にわたるAIシグナル。', placeholder: 'ティッカー、企業、暗号資産、コモディティ...', popular: '人気:', generateReport: 'レポートを生成', viewReport: '現在のレポートを見る', compare: '2つの資産を比較', liveActivity: 'ライブ' },
            report: { generating: '{{ticker}}を分析中...', complete: '分析完了', signals: '{{count}}件のシグナルを処理', sharedReport: '共有レポート', reportId: 'レポートID', generatedAt: '生成日時', researchers: '人のアナリスト', viewFull: '全レポートを表示', subscribe: '{{ticker}}の更新を購読', nextRefresh: '次の更新: {{hours}}時間後' },
            ...
            tier: { free: '無料', unlocked: 'アンロック済み', institutional: '機関投資家向け', unlock: '全レポートを解除', signUpFree: '無料で登録' },
