...
export const servicePages: ServicePage[] = [
  ...
  },
  {
    ...
    title: "Web development and search visibility",
    shortTitle: "Web & search visibility",
    navLabel: "Websites & search visibility",
    description:
    ...
    seoTitle: "Web Development, Technical SEO & AI Search Visibility",
    seoDescription:
    ...
    heroEyebrow: "Web products and search visibility",
    heroTitle: "Build a digital product people can find, understand, and trust.",
    heroDescription:
    ...
    metrics: [
      ...
      { label: "Search foundation", value: "Crawlability, structure, and answer readiness" },
      { label: "Measurement", value: "Search, analytics, and conversion signals" },
    ],
    items: [
  ...
  {
    slug: "content-operations-automation",
    path: "/services#content-operations-automation",
    icon: RefreshCw,
    title: "Digital products and content operations",
    shortTitle: "Content operations",
    navLabel: "Content operations & digital products",
    description:
    ...
    seoTitle: "Content Operations, Repurposing & Digital Products",
    seoDescription:
    ...
    heroEyebrow: "Modern content systems and digital products",
    heroTitle: "Turn expertise into a repeatable content and product engine.",
    heroDescription:
    ...
    metrics: [
      { label: "Content engine", value: "Audio and video to multi-channel assets" },
      { label: "Operating model", value: "AI-assisted with editorial approval" },
      { label: "Product layer", value: "Templates, data packs, and marketplaces" },
    ],
    items: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    title: "Data and AI enablement and mentorship",
    shortTitle: "Enablement & mentorship",
    navLabel: "Team enablement & career mentorship",
    description:
    ...
    seoTitle: "Data & AI Enablement, Training and Career Mentorship",
    seoDescription:
    ...
    heroEyebrow: "Practical capability for people and teams",
    heroTitle: "Build the skills, judgment, and confidence to use data and AI well.",
    heroDescription:
    ...
    metrics: [
      { label: "Audiences", value: "Individuals, analysts, managers, and teams" },
      { label: "Formats", value: "Team workshops and one-to-one mentorship" },
      { label: "Focus", value: "Skills, projects, adoption, and progression" },
    ],
    items: [
