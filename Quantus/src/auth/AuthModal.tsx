...
import { X, Zap, Mail, Lock, User, Eye, EyeOff } from 'lucide-react';
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold" style={{ color: tp }}>Quantus Investing</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{ background: inputBg, border: `1px solid ${border}` }}>
                                ...
                                <input
                                    type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPass(e.target.value)}
                        ...
                        {mode === 'signup' && (
                            <div>
                                <label className="block text-xs font-semibold mb-1.5" style={{ color: ts }}>Confirm Password</label>
                                <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{ background: inputBg, border: `1px solid ${border}` }}>
                                    <Lock className="w-4 h-4 flex-shrink-0" style={{ color: '#6B7280' }} />
                                    <input
                                        type="password" value={confirmPassword} onChange={e => setConfirmPass(e.target.value)}
