    ...
    return (
        <SectionCard title="C — Risk" id="section-3" lightMode={lightMode}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
                ...
                <MetricCard label="Expected Shortfall" value={report.risk.expected_shortfall} lightMode={lightMode} />
                <MetricCard label="Max Drawdown" value={report.risk.max_drawdown} lightMode={lightMode} />
                <MetricCard label="Sharpe Ratio" value={report.risk.sharpe_ratio.toFixed(2)} note={report.risk.peer_avg_sharpe ? `vs. peer avg: ${report.risk.peer_avg_sharpe}` : undefined} lightMode={lightMode} />
            </div>
